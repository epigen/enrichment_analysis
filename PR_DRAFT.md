...
Add bundled integration test fixtures and CI workflow for enrichment analysis
...
- The GitHub Actions workflow test was simulated on my pc locally with `act` and ran successfully end-to-end
